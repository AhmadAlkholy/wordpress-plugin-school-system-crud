				...
				<table data-vertable="ver2">
					<thead>
						<tr class="row100 head">
							<th class="column100 column1" data-column="column1">Teacher's Name</th>
							<th class="column100 column2" data-column="column2">Teacher's Address</th>
							<th class="column100 column3" data-column="column3">Teacher's Email</th>
							<th class="column100 column4" data-column="column4">Teacher's Phone</th>
							...
							<?php if ( is_admin() ): ?>
								<td class="column100 column6" data-column="column6">
									<a href="<?php echo admin_url( "admin.php?page=new_$cell&id=$row->id" )?>" >
										<button class="crud-btn edit-btn" data-action="edit" data-target="<?php echo $row->id ?>">
										Edit
										</button>
									</a></td>
